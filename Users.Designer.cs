...
namespace Shop_WorldSkills.UsersTableAdapters {
...
SELECT MigrationId, ContextKey, Model, ProductVersion FROM __MigrationHistory WHERE (ContextKey = @ContextKey) AND (MigrationId = @MigrationId)";
        ...
        public virtual int Fill(Users.@__MigrationHistoryDataTable dataTable) {
        ...
        public virtual Users.@__MigrationHistoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Users.@__MigrationHistoryDataTable dataTable = new Users.@__MigrationHistoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Users.@__MigrationHistoryDataTable dataTable) {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [Email] = @Email, [Password] = @Password WHERE (([id] = " +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Email, string Password, int Original_id, int id) {
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
            else {
        ...
        public virtual int Update(string Email, string Password, int Original_id) {
            return this.Update(Email, Password, Original_id, Original_id);
        }
    }
